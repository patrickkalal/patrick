# Generated by Django 4.2.5 on 2023-09-13 11:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nomPaysId', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, to='colis.pays')),
            ],
        ),
        migrations.CreateModel(
            name='Coli',
            fields=[
                ...
                ('typeColiId', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, to='colis.typecoli')),
                ('villeEnvois', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, to='colis.ville')),
            ],
            options={
                'verbose_name': 'Coli',
